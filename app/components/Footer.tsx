    ...
    <footer className="relative bg-[var(--color-ink)] text-white">
      ...
      <div className="max-w-[1200px] mx-auto px-5 md:px-6 py-12 md:py-16">
        <div className="grid md:grid-cols-2 gap-10 mb-12">
          ...
          <StaggerReveal staggerIndex={1} className="flex flex-col md:items-end gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 text-base text-white hover:text-[var(--color-primary)] transition-colors"
            >
              <Mail size={18} />
              hello@phaneos.cloud
            </a>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <nav className="flex gap-6 text-sm text-white/70" aria-label="Footer navigation">
